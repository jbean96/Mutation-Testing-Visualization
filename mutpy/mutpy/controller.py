...
class MutationScore:
    ...
    def get_dict(self):
        return_obj = {}
        return_obj['count'] = self.count()
        return_obj['covered_nodes'] = self.covered_nodes
        return_obj['all_nodes'] = self.all_nodes
        return_obj['killed_mutants'] = self.killed_mutants
        return_obj['timeout_mutants'] = self.timeout_mutants
        return_obj['incompetent_mutants'] = self.incompetent_mutants
        return_obj['survived_mutants'] = self.survived_mutants
        return_obj['all_mutants'] = self.killed_mutants + self.timeout_mutants + self.incompetent_mutants + self.survived_mutants
